...
const value = '<div data-avatar="https://cdn.example.com/avatar.jpg"></div>'
const expected = '<div data-avatar="https://proxy.example.com/avatar.jpg"></div>'

expect(await transform(value)).toBe(expected)

// Avoid - substring check on a small fixture leaves the rest of the output unverified
expect(await transform(value)).toContain('data-avatar="https://proxy.example.com/avatar.jpg"')
```
