...
Micro-wins in pipeline libraries are often macro-invisible: a function can get 40% faster while whole-pipeline throughput moves 0% because a dependency (XML parser, DOM, network) dominates. Trial-verified on a parser library: two variants won 1.4–2× in micro-benchmarks and produced 1.00 ± 0.02 end-to-end.
